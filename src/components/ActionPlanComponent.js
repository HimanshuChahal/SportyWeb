...
export default () => {
    ...
    return (
        <div className = 'Container'>
            ...
            <div style = {{ display: 'flex', flex: 1, flexDirection: 'row', marginTop: 40, marginLeft: 40, marginRight: 40 }}>
                ...
                <div style = {{ display: 'flex', flex: 1.1, flexDirection: 'column', marginRight: 40, textAlign: 'center', fontSize: 30, color: 'white' }}>
                    ...
                    <div style = {{ display: 'flex', flexDirection: 'row', marginTop: 60, borderRadius: 20, backgroundColor: '#222222', boxShadow: '1px 2px black inset' }}>
                    ...
                    <div style = {{ fontSize: 20, marginTop: 40 }}>You are doing great</div>

                    <div style = {{ display: 'flex', flexDirection: 'column', marginTop: 40, alignItems: 'center' }}>

                        <div style = {{ display: 'flex', flexDirection: 'row', maxWidth: '100%', paddingTop: 10, paddingBottom: 10, paddingLeft: 60, paddingRight: 60, backgroundColor: '#4A4A4A', borderRadius: 10, boxShadow: '0px 3px 1px 0px #888888 inset', color: 'white', fontSize: 14, alignItems: 'center' }}>
                ...
                <div style = {{ display: 'flex', flex: 2, flexDirection: 'column', marginLeft: 40 }}>
                    ...
                    <div style = {{ display: 'flex', flexDirection: 'row', marginTop: 20 }}>
                        ...
                        <div style = {{ display: 'flex', flex: 1, marginRight: 20, justifyContent: 'flex-end' }}>
                            ...
                            <div style = {{ paddingTop: 15, paddingBottom: 15, paddingLeft: 40, paddingRight: 40, backgroundColor: type === 0 && '#111111', borderTopLeftRadius: 20, borderTopRightRadius: 20, color: 'white', cursor: 'pointer', boxShadow: '1px 2px 3px black inset' }}
                            onClick = {() => setType(0)}>
                        ...
                        <div style = {{ display: 'flex', flex: 1, marginLeft: 20 }}>
                            ...
                            <div style = {{ paddingTop: 15, paddingBottom: 15, paddingLeft: 40, paddingRight: 40, backgroundColor: type === 1 && '#111111', borderTopLeftRadius: 20, borderTopRightRadius: 20, color: 'white', cursor: 'pointer', boxShadow: '1px 2px 3px black inset' }}
                            onClick = {() => setType(1)}>
                    ...
                    <div className = 'bg5' style = {{ display: 'flex', flexDirection: 'column', height: window.innerHeight/2, overflowY: 'scroll', marginLeft: 40, marginRight: 40, borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingTop: 20, paddingBottom: 20, borderTopWidth: 2, borderLeftWidth: 1, borderRightWidth: 1, borderWidth: 5, borderColor: 'white', boxShadow: '0px 4px black inset' }}>
            ...
            <div style = {{ marginTop: 20, marginLeft: 60, color: 'white', fontSize: 30 }}>Progress</div>

            <div style = {{ display: 'flex', flexDirection: 'row', marginTop: 20, alignItems: 'center', marginLeft: 60, marginRight: 60, marginBottom: 70 }}>
