                ...
                }
                {
                    (question === 1) && (
                        <div style = {{ display: 'flex', flex: 1, flexDirection: 'column' }}>
                            ...
                            <div style = {{ display: 'flex', flexDirection: 'row', marginTop: 40, marginLeft: '20%', marginRight: '20%' }}>
                ...
                }
                {
                    (question === 2) && (
                        <div style = {{ display: 'flex', flex: 1, flexDirection: 'column' }}>
                            ...
                            <div style = {{ display: 'flex', flexDirection: 'column', marginTop: 40, marginLeft: '20%', marginRight: '20%', backgroundColor: '#4A4A4A', borderRadius: 20, boxShadow: '2px 4px 6px black' }}>
                                ...
                                <div style = {{ width: '20%', alignSelf: 'center' }}>
                                    ...
                                    <div style = {{ display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        <input style = {{ alignSelf: 'center', width: '60%', marginTop: 20, marginLeft: -10, paddingTop: 10, paddingBottom: 10, paddingLeft: 10, paddingRight: 10, borderRadius: 20, borderWidth: 0, outline: 'none', backgroundColor: '#222222', boxShadow: '1px 2px black inset', color: 'white', fontSize: 16 }} type = 'text'
                                        onClick = {() => setSelected(-1)}/>
                                        ...
                                        onClick = {() => navigate('/action_plan')}>Next</button>
